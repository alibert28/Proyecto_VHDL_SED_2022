...
HD_PWD='D:/Proyectos/VHDL/VHDL_PROJECT/PRODUCT_SELECTOR/PRODUCT_SELECTOR.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PRODUCT_SELECTOR.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PRODUCT_SELECTOR.tcl
