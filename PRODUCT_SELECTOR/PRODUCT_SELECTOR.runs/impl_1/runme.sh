...
HD_PWD='D:/Proyectos/VHDL/VHDL_PROJECT/PRODUCT_SELECTOR/PRODUCT_SELECTOR.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PRODUCT_SELECTOR.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PRODUCT_SELECTOR.tcl -notrace
